...
- (void) testGetSharedDocumentWithoutDelegate{
    self.sharedInstance.delegate = nil;
    XCTAssertThrows([self.sharedInstance createCoreDataSharedDocument], @"Delegate should be set before asking for a document");
}
...
//    
//    //exercise
//    [self.sharedInstance createCoreDataSharedDocument];
//    
//    //verify
...
//}
//
//- (void) testMultipleSaveAndDeleteCycles{
//    
//    //setUp
//    __block NSManagedObjectContext *managedObjectContext;
//    
...
//    WAIT_WHILE(!managedObjectContext, 2.0);
//    
//    XCTAssertTrue([self.sharedInstance deleteSharedDocument],@"Shared Document was not deleted");
...
//    //setup
//    
//    id errorManagedDocument = [OCMockObject partialMockForObject:self.sharedInstance.sharedDocument];
//    
...
//    //tearDown
//    [self.sharedInstance deleteDummyDocument];
//    [errorManagedDocument stopMocking];
//    errorManagedDocument = nil;
//    
//    
//}
