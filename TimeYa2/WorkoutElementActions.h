...
/** Returns an activity at the next index position to the parent activity.
 ...
 @return Returns the next activity in the parent relative to the child. If the child activity is at the last index position of the parent, meaning there is no next activty, the method returns nil.
 */
